" Name:       meh.vim
" Version:    0.1
" Maintainer: github.com/wfleming
...
" make pretty much all recognized syntax look 'normal'
...
call s:h("CursorLine",    {}) " don't change the cursor line, just the nr^
